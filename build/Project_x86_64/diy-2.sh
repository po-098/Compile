...
sed -i "/uci commit network/i\uci set network.lan.ipaddr='192.168.31.119'" $ZZZ              # IPv4 地址(openwrt后台地址)
...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='Sunny-119'" $ZZZ       # 修改主机名称为OpenWrt-123
